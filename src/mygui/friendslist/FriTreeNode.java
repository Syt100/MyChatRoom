...
public class FriTreeNode implements TreeNode {
	...
	public FriTreeNode(String ID, String name) {
		this.ID = ID;
		this.uName = name;
	}

	public FriTreeNode(String iD, String uName, ImageIcon img) {
		ID = iD;
		this.img = img;
		this.uName = uName;
	}

	public FriTreeNode(String ID, String name, ImageIcon img, String text) {
		this.uName = name;
		this.text = text;
		this.img = img;
		this.ID = ID;
