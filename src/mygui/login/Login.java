...
public class Login {
	...
	private void initialize() {
		...
		label.setIcon(new ImageIcon(Login.class.getResource("/Images/4f321ae9fa813abf6522eccf72d0095f_5.jpg")));
		...
		label_1.setIcon(new ImageIcon(Login.class.getResource("/Images/avatar_users_48px_1108447_easyicon.net.png")));
