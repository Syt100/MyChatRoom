 ...
 * 
 * @author 米强<转载请注明作者与来源>https://blog.csdn.net/ycb1689/article/details/8330226
...
public class MQFontChooser extends JDialog {
	...
	private String[] sizeArray = { "8", "9", "10", "11", "12", "14", "16", "18", "20", "22", "24", "26", "28", "36",
			"48", "初号", "小初", "一号", "小一", "二号", "小二", "三号", "小三", "四号", "小四", "五号", "小五", "六号", "小六", "七号", "八号" };
	/** 上面数组中对应的字体大小 */
	private int[] sizeIntArray = { 8, 9, 10, 11, 12, 14, 16, 18, 20, 22, 24, 26, 28, 36, 48, 42, 36, 26, 24, 22, 18, 16,
	...
	public MQFontChooser(Font font) {
		showFont = new Font("微软雅黑", Font.PLAIN, 12);
		setTitle("选择字体");
		this.font = font;
		// 初始化UI组件
		init();
...
//		setResizable(false);
	...
	private void init() {
		...
		chinaButton.setFont(showFont);
		englishButton = new JRadioButton("英文预览");
		englishButton.setFont(showFont);
		numberButton = new JRadioButton("数字预览");
		numberButton.setFont(showFont);
