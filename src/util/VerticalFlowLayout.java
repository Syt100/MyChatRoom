...
public class VerticalFlowLayout implements LayoutManager {
	...
	/**
	 * 构造一个新的 VerticalFlowLayout，它是居中对齐的，默认的水平和垂直间隙是 5 个单位， 组件的宽度不自适应于容器。
	 */
	...
	/**
	 * 构造一个新的 VerticalFlowLayout，它具有指定的对齐方式，默认的水平和垂直间隙是 5 个单位， 组件的宽度不自适应于容器。<br>
	 * align 参数的值必须是以下值之一：VerticalFlowLayout.TOP、VerticalFlowLayout.CENTER 或
	...
	/**
	 * 构造一个新的 VerticalFlowLayout，它具有指定的对齐方式以及指定的水平和垂直间隙， 组件的宽度不自适应于容器。<br>
	 * align 参数的值必须是以下值之一：VerticalFlowLayout.TOP、VerticalFlowLayout.CENTER 或
	 * VerticalFlowLayout.BOTTOM。
	 * 
	 * @param align 对齐值
	 * @param hgap  组件之间以及组件与 Container 的边之间的水平间隙
	 * @param vgap  组件之间以及组件与 Container 的边之间的垂直间隙
	 */
	...
	/**
	 * 构造一个新的 VerticalFlowLayout，它具有指定的对齐方式以及指定的水平和垂直间隙， 并指定组件的宽度是否自适应于容器。<br>
	 * align 参数的值必须是以下值之一：VerticalFlowLayout.TOP、VerticalFlowLayout.CENTER 或
	 * VerticalFlowLayout.BOTTOM。
	 * 
	 * @param align 对齐值
	 * @param hgap  组件之间以及组件与 Container 的边之间的水平间隙
	 * @param vgap  组件之间以及组件与 Container 的边之间的垂直间隙
	 * @param hfill 如果为true，组件的宽度将自适应于容器
	 */
	...
	/**
	 * 获取此布局的对齐方式。可能的值是VerticalFlowLayout.TOP、VerticalFlowLayout.CENTER 或
	 * VerticalFlowLayout.BOTTOM。
	 */
	 ...
	 * 
	 * @param vgap 组件之间以及组件与Container 的边之间的垂直间隙
	 */
	...
	/**
	 * 布置指定的目标容器。此方法通过获取指定的目标容器中每个组件的首选大小来进行重塑 以满足此VerticalFlowLayout对象的对齐方式
	 * 
	 * @param target 指定的目标容器
	 */
	 ...
	 * @param y        指定的Y坐标
	 * @param width    指定的宽度尺寸
	 * @param height   指定的高度尺寸
	 * @param colStart 指定列的开始
	 * @param colEnd   指定列的结尾
	 */
