...
public class ChatBubble extends JPanel {
	 ...
	 * @param isSelf
	 */
	public ChatBubble(boolean isSelf) {
		this.isSelf = isSelf;
		init();
	}
	 ...
	 * @param message
	 */
	public ChatBubble(boolean isSelf, String message) {
		this.isSelf = isSelf;
		this.message = message;
		init();
	}
	 ...
	 * @param message
	 */
	public ChatBubble(boolean isSelf, String name, String message) {
		this.isSelf = isSelf;
		this.name = name;
		this.message = message;
		init();
	 ...
	 * @param message
	 */
	public ChatBubble(boolean isSelf, BufferedImage image, String name, String message) {
		this.isSelf = isSelf;
		this.image = image;
		this.name = name;
		this.message = message;
